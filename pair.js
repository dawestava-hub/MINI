...
╭───❏ *BOT STATUS* ❏
│ *Bot Name*: ${title}
│ 👑 *Owner*: ${config.OWNER_NAME || 'MUZAMIL-XMD '}
...
🕒 Connecting: The bot will become active in a few seconds`,
  useBotName
);
  ...
  useBotName,
  `✅ Successfully connected and now ACTIVE!
